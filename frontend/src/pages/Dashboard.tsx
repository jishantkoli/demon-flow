...
import { 
  ...
  Activity, Award, UserPlus, Calendar, Target, AlertTriangle 
} from 'lucide-react';
    ...
    <div className="max-w-[1400px] mx-auto space-y-8 pb-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 space-y-8">
          ...
          {/* Visual Activity Chart (Merged from Analytics) */}
            ...
            <div className="divide-y divide-slate-50">
              {recentSubs.length === 0 ? (
                ...
                <div
                  ...
                  className="w-full text-left px-8 py-4 flex items-center gap-4 transition-all hover:bg-slate-50/80 cursor-pointer group"
                >
        ...
        {/* Right Column: Status Summary (The "badiya" one) */}
        <div className="lg:col-span-4 space-y-8">
          <motion.div {...anim(3)} className="bg-white rounded-[2.5rem] border border-slate-200 p-8 shadow-sm relative overflow-hidden group">
            ...
            <div className="flex items-center justify-between mb-8 relative">
              ...
              <div className="w-10 h-10 rounded-full bg-slate-50 border border-slate-100 flex items-center justify-center text-[10px] font-black text-slate-600">
                  ...
                  <div key={st.label}>
                    <div className="flex items-center justify-between mb-2.5">
                      <div className="flex items-center gap-3">
                        <div className={`w-7 h-7 rounded-xl ${st.bg} ${st.text} flex items-center justify-center shadow-sm`}>
                          <st.icon size={14} />
                        </div>
          ...
          <div className="bg-primary/5 rounded-[2.5rem] border border-primary/10 p-8">
            <div className="w-11 h-11 bg-primary/10 rounded-2xl flex items-center justify-center text-primary mb-5 shadow-sm">
              <Award size={22} />
            </div>
            <h3 className="font-black text-slate-900 text-sm mb-2">School Platform</h3>
            <p className="text-[11px] text-slate-500 leading-relaxed font-medium">System is running optimally. Total {s.activeForms || 0} forms are currently collecting responses across the network.</p>
          </div>
        </div>
      </div>
    </div>
