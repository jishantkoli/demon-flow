    ...
    <div className="card !p-0 overflow-hidden shadow-2xl">
      ...
      >
        <div className="flex items-center gap-4 relative z-10">
          {form.settings.logo_image && (
            <div className="w-20 h-20 sm:w-24 sm:h-24 bg-white/10 backdrop-blur-md rounded-xl flex items-center justify-center border border-white/20 shrink-0 overflow-hidden">
              <img 
